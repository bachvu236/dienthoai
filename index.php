			...
			<div class="preload"><div></div></div>
				<div id="lof-main-outer">
					<ul class="lof-main-wapper">
						<li><img src="img/slide/iphone.png" width="1000" height="350"></li>
						<li><img src="img/slide/slide2.png" width="1000" height="350"></li>
						<li><img src="img/slide/slide3.png" width="1000" height="350"></li>
						<li><img src="img/slide/samsung2.png" width="1000" height="350"></li>
					</ul>
				</div>
			...
			<div id="noidungfooter">
				...
				<div id="noidung">
					<ul>
						...
						<li>Địa chỉ:  Phú diễn - Nam Từ Liêm - Thành Phố Hà Nội </li>
						<li>Điện thoại: 091233333 - Hotline:  091233333</li>
				...
				<div id="copyright">
					<p>Sinh Viên : Vũ Xuân Bách | Lớp : ĐH6C1 | Gmail : bachvu236@gmail.com<p>
				</div><!-- End .copyright -->
