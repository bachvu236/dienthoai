...
?> <?php  echo number_format($tongtien,"0",",",".");?> VNĐ
				...
				<div id="yahoo">
					<div class="center1">
						<h4>Liên Hệ</h4>
						<h2><a href="https://chat.zalo.me/"><img src="img/zalo.png" width = "70" height = "70"></a></h2>
							<p>0978164307</p>
						<h2><a href="#"><img src="img/imonline.png"></a></h2>
							<p>0982612514</p>
					</div><!-- End .center1-->
				</div><!-- End .yahoo -->
				...
				<div id="fb-root">
					<div class="center1">
						...
						<div class="fb-like-box" data-href="https://www.facebook.com/LienMinhHuyenThoai" data-width="188" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="false"></div>
					</div><!-- End .center1 -->
				</div><!-- End .facebook -->